...
def main():
    ...
    if page_selection == "The Team":
        ...
        st.image("Pictures//Temo.jpg", width=300)  # Adjust the width as needed
        ...
        st.image("Pictures//Kedijang.jpg", width=300)
        ...
        st.image("Pictures//Tonia.jpg", width=300)
        ...
        st.image("Pictures//Edicool.jpg", width=300)
        ...
        st.image("Pictures//Pricilla.jpg", width=300)
        ...
        st.image("Pictures//Winnie.jpg", width=300)

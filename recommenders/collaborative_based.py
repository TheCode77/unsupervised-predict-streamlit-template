...
def collab_model(movie_list,top_n=10):
    ...
    sim_series_1 = pd.Series(rank_1).sort_values(ascending = False)
    sim_series_2 = pd.Series(rank_2).sort_values(ascending = False)
    sim_series_3 = pd.Series(rank_3).sort_values(ascending = False)
    
    # Appending the names of movies
    sim_score_list = sim_series_1.append(sim_series_1).append(sim_series_2).append(sim_series_3).sort_values(ascending = False)
